        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-700 dark:text-gray-300">
              Economist, Video Editor, Content Writer
            </h2>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              A highly skilled Economist, Video Editor, and Content Writer with
              a strong background in management and business administration.
              Experienced in market analysis, content creation, and video
              production, with excellent analytical, organizational, and
              leadership skills.
            </p>
