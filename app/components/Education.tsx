  ...
  const education = [
    {
      ...
      achievements: [
        "Completed coursework in economics, management, and business administration.",
        "Built strong foundations in market analysis, finance, and organizational management.",
      ],
    },
    {
      degree:
        "Certificate Program in English Speaking and Communication Skills",
      institution: "Lincoln Learning Center",
      period: "Feb 2020 – Jul 2020",
      achievements: [
        "Enhanced advanced English speaking and communication skills.",
        "Gained confidence in professional and academic presentation.",
      ],
    },
  ];
